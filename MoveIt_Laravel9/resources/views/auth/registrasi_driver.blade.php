...
<style>
    .gradient-custom {
        ...
        background: -webkit-linear-gradient(to right, rgb(0, 0, 0), rgba(rgb(125, 125, 125)));
                        ...
                        <div class="">
                            ...
                            <form action="{{ route('registrasi.driver.action') }}" method="POST">
                                ...
                                <div class="form-outline form-dark mb-4">
                                    <input class="form-control form-control-lg" type="name" name="name" value="{{ old('name') }}" required />
                                ...
                                <div class="form-outline mb-4">
                                    <input class="form-control form-control-lg rounded-1" type="text" name="tanggal_lahir" id="datepicker"></p>
                                    <label class="form-label" for="tanggal_lahir">Tanggal Lahir</label>
                                </div>
                                @else
                                <div class="form-outline mb-4">
                                    <input class="form-control form-control-lg rounded-1" type="text" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" id="datepicker"></p>
                                    <label class="form-label" for="tanggal_lahir">Tanggal Lahir</label>
                                </div>
                                @endif

                                <div class="form-outline mb-4">
                                    <input class="form-control form-control-lg" type="nik" name="nik" value="{{ old('nik') }}" required />
                                    <label class="form-label" for="nik">NIK</label>
                                </div>

                                <div class="form-dark mb-4">
                                    <select class="form-control form-control-lg" name="jenis_kendaraan" id="PilihKendaraan">
                                ...
                                <div class="form-outline form-dark mb-4">
                                    <input class="form-control form-control-lg" type="nomor_polisi" name="nomor_polisi" required value="{{ old('nomor_polisi') }}"/>
                                ...
                                <div class="form-outline form-dark mb-4">
                                    <input class="form-control form-control-lg" type="password" name="password_confirm" required />
