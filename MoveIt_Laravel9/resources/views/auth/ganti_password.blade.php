                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="">
                            ...
                            <form action="{{ route('ganti.password.action') }}" method="POST">
                                ...
                                <div class="form-outline form-dark mb-4">
                                    <input class="form-control form-control-lg" type="password" name="new_password" required />
                                    <label class="form-label" for="new_password">Password Baru</label>
                                </div>

                                <div class="form-outline form-dark mb-4">
                                    <input class="form-control form-control-lg" type="password" name="new_password_confirmation" required />
