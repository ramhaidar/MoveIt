                            ...
                            <div class="">
                                ...
                                <form action="{{ route('registrasi.customer.action') }}" method="POST">
                                    ...
                                    <div class="form-outline form-dark mb-4">
                                        @if (old('name') == null)
                                            <input class="form-control form-control-lg" autocomplete="off" type="name" name="name" value="Fawwas Hamid" required />
                                        @else
                                    ...
                                    <div class="form-outline form-dark mb-4">
                                        @if (old('username') == null)
                                            <input class="form-control form-control-lg" autocomplete="off" type="username" name="username" value="fawwas123" required />
                                        @else
                                    ...
                                    <div class="form-outline form-dark mb-4">
                                        @if (old('email') == null)
                                            <input class="form-control form-control-lg" autocomplete="off" type="email" name="email" value="fawwashamid@gmail.com" required />
                                        @else
                                    ...
                                    <div class="form-outline mb-4">
                                        @if (old('tanggal_lahir') == null)
                                            <input class="form-control form-control-lg rounded-1" autocomplete="off" type="text" name="tanggal_lahir" value="23/11/2001" id="datepicker"></p>
                                        @else
